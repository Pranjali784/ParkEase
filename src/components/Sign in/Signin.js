...
function Signin() {
  return (
    <div className="signin-container-unique">
      <form className="form-unique">
        <div className="flex-column-unique">
          <label>Email</label>
        </div>
        <div className="input-form-unique">
          <svg
          ...
          <input placeholder="Enter your Email" className="input-unique" type="text" />
        </div>
        ...
        <div className="input-form-unique">
          ...
          <input placeholder="Enter your Password" className="input-unique" type="password" />
        </div>
        ...
        <div className="flex-row-unique">
          ...
          <span className="span-unique">Forgot password?</span>
        </div>
        <button className="button-submit-unique">Sign In</button>
        <p className="p-unique">
          Don't have an account? <span className="span-unique">Sign Up</span>
        </p>
        <p className="p-unique line-unique">Or With</p>
        ...
        <div className="flex-row-unique">
          ...
          <button className="btn-apple-unique">
            <svg
              style={{ enableBackground: 'new 0 0 22.773 22.773' }}
              viewBox="0 0 22.773 22.773"
              width="20"
